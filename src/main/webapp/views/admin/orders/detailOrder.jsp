...
<body>
	<div class="wrapper">
		<div id="content">
			...
			<br><br>
				<h4 class="text-center">Thông tin chi tiết đơn hàng</h4>
				<div class="row">
						...
						<div class="modal-content">
							<div class="col-md-6 border-right">
								<div class="p-3 py-5">
									...
									<div class="row mt-2">
										<div class="col-md-12">
											<label class="mr-2">Tổng tiền đơn:
